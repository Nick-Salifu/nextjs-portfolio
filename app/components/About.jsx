            ...
            >
              {infoList.map(({icon, iconDark, title, description}, index) => (
                <motion.li
                  ...
                  key={index} className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-light hover:shadow-black hover:-translate-y-1 duration-500 dark:border-white dark:hover:shadow-[4px_4px_0_#fff] dark:hover:bg-dark/50">
