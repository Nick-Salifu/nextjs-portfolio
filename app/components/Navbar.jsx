  ...
  return (
    <div className="pb-12">
        <div className="fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden">
            <Image src={assets.header_bg_color} alt="background color" className="ml-24" />
        </div>
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex justify-between items-center z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-odd dark:shadow-white/20" : ""}`}>
            <a href="#top">
                <Image src={darkMode ? assets.dark_logo : assets.nick_logo} alt="logo" className="cursor-pointer w-60 mr-14 bg-transparent" />
            </a>
